...
const About = () => {
  return (
    <>
      ...
      >
        I am a data engineer, UI developer, back-end developer with a passion for connecting all
        the dots in an enterprise to come up with  the business solutions. I am looking
